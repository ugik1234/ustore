                ...
                <div class="popup-table">
                    ...
                    <div class="popup-cell">
                        <div class="popup-buttons">
                            <a href="product.html"><span class="icon icon-eye"></span>
                                <span class="hidden-xs">View more</span></a>
                            <a href="javascript:void(0);"><span class="icon icon-cart"></span>
                                <span class="hidden-xs">Buy</span></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <ul class="stretcher">
            ...
            <li class="stretcher-item" style="background-image: url(assets/images/shop-7.jpg)">
                ...
                <figure>
                    ...
                    <figcaption>
                        Choose among a wonderful variety of refined and feminine
                        timepieces
                    </figcaption>
                </figure>
                <!--anchor-->
            ...
            <li class="stretcher-item" style="background-image: url(assets/images/shop-8.jpg)">
                ...
                <figure>
                    ...
                    <figcaption>
                        Discover your favourite model by combining materials
                    </figcaption>
                </figure>
                <!--anchor-->
                <a href="#">Anchor link</a>
            ...
            <li class="stretcher-item" style="background-image: url(assets/images/shop-9.jpg)">
                ...
                <figure>
                    ...
                    <figcaption>
                        Diamond bezel watch collection of luxurious pieces
                    </figcaption>
                </figure>
                <!--anchor-->
                <a href="#">Anchor link</a>
                    ...
                    <article>
                        <a href="article.html">
                            ...
                            <div class="entry entry-table">
                                ...
                                <div class="title">
                                    <h2 class="h5">
                                        Lock the front door when you head to work
                                    </h2>
                                </div>
                            </div>
                        </a>
