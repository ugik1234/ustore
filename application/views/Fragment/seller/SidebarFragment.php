    ...
    <div class="navbar-box">
      <div class="box-full">
        <div class="box clearfix">
          <ul>
            <li class="label">Seller Menu</li>
            <li><a href="<?= site_url('Seller/my_product') ?>">My Product</a></li>
            <li><a href="<?= site_url('Seller/penjualan') ?>">Penjualan</a></li>
            <!-- <li><a href="<?= site_url('Seller/kelolah_customer') ?>">Kelolah Customer</a></li> -->
          </ul>
        </div>
      </div>
    </div>
