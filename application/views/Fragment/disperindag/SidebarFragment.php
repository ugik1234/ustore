...
<nav class="navbar-default navbar-static-side" role="navigation">
  <div class="sidebar-collapse">
    <ul class="nav metismenu" id="side-menu">
      ...
      <li id="daftar_req_disperindag">
        <a href="<?=site_url("DisperindagController/daftar_req_disperindag")?>"><i class="fa fa-file-alt"></i> <span class="nav-label">Daftar Permohonan</span></a>
      </li>
      <li id="logout">
